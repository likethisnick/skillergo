...
/** Size and damage of this player's shotgun blast (also used by client-side prediction). */
export function shotgunCone(p: Readonly<Player>, server: Readonly<ServerConfig>): { range: number; arc: number; damage: number } {
