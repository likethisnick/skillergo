...
| `rifleDamage` | Marksman: one heavy shot (~1.5x the gunner's DPS when every shot lands) |
| `fireballDamage` | Summoner: damage of the fireball burst |
| `blinkDamage`, `whirlwindDamage` | Bastard: damage where he lands and of the spin around him |
...
{"version":1,"startedAt":"...","endedAt":"...","durationSeconds":184.2,"endReason":"death",
 ...
 "difficultyReached":0.31,"class":"gunner","weapon":"gun","ability":"shotgun","level":4,"xp":350,
...
The class is picked on the start screen, left of the Play button.
...
A class is a fixed weapon (LMB) + ability (RMB, unlocks at level 2) pair:

| Class | LMB | RMB |
|---|---|---|
| Fighter | Sword: wide close-range swing | Hook: pulls an enemy to you |
| Laser | Beam: weak but constant damage | Shield: blocks the side you face for 2 s |
| Gunner | Gun: auto-fire bullets | Shotgun: point-blank cone blast |
| Marksman | Rifle: one heavy, very fast shot per 0.8 s at 0.95 of the tower range (≈1.5x the gunner's DPS when every shot lands) | Cloak: invisible for 3 s; attacking gives you away |
| Summoner | Fireball: slow ball, bursts on contact or at the end of its flight, area damage | Rally: friendly mobs around you get +40% speed and +50% damage (yellow aura) and go for the target under your cursor |
| Bastard | Blink: short teleport towards the cursor, hurts everything where you land | Whirlwind: one sweep that hits everything around you |

The marksman sees 25% more of the world than everybody else, because his rifle shoots farther than a standard
